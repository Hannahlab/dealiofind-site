...
function HeroBanner() {
  ...
  return (
    <section className="relative">
      <div className="max-w-6xl mx-auto bg-[#ede5d7] relative min-h-[280px] sm:min-h-[360px] lg:min-h-[440px] flex items-center justify-center rounded-2xl overflow-hidden">
